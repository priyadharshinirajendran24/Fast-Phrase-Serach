<%-- 
    Document   : DataOwnerHome
    Created on : Aug 31, 2018, 11:13:30 AM
    Author     : Priya
--%>
            ...
            <div class="col-sm-2" style="background-color:#333333;height: 650px;">
             ...
             <div class="col-sm-8" style="background-color:whitesmoke;height: 650px;">
                 ...
                 <p style="text-align: justify; margin-left: 100px;margin-right:100px;font-size: 17px;font-family: 'Raleway', sans-serif;">
                   <form  action="OwnerLoginConn.jsp" name="form1" onsubmit="return SignupValidate()" method="post" >
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <center><h4>Data Owner Signup</h4></center>
    </div>
    <div class="modal-body">
        <center>
         <form action="DataOwnerReg" method="post" enctype="multipart/form-data">
