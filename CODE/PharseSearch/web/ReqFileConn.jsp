<%-- 
    Document   : ReqFileConn
    Created on : Sep 14, 2018, 4:58:21 PM
    Author     : Priya
--%>
...
%>
             ...
             <div class="col-sm-8" style="background-color:whitesmoke;height: 900px;">
                 ...
                 %>
                 <div align="center">
                     <form  action="Down.jsp?fid=<%=fid%>" name="form1" onsubmit="return SignupValidate()" method="post" >
                   
                                <table align="center" style="margin-top: 50px;">
                                  <input type="text" name="deckey" style="width:55%;height:40px;"><br><br>
                                  <input type="submit" name="key" value="Verify" style="border-radius: 5pt 5pt;margin-top: 10px;background-color: black;color: white; width: 100px; text-align: center;">
                                </table>
                      </form>
                 </div>  
            </div> 
